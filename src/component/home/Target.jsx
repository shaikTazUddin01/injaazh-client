...
const Target = () => {
    return (
        <div className="max-w-[1440px] mx-auto px-5 lg:px-10 ">
            <div className='grid grid-cols-1 md:grid-cols-2 md:items-center lg:items-start border-x border-[var(--secondary-color)]'>
                <div className='text-white pb-10 lg:pb-0'>
                    <div role="tablist" className="tabs tabs-bordered">
                        ...
                        <div role="tabpanel" className="tab-content pt-2 lg:pt-20 space-y-5">
